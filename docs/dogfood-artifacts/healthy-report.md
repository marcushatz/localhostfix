...
- Render: 776 visible elements, 8726 chars of visible text, title "Example App — marketing site"

## Strongest evidence

- page rendered with 776 visible elements and 8726 characters of text
